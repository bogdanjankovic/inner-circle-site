...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length > 0) {
            ...
            System.err.println("Opening replay: " + replayPath);
            try (java.io.InputStream is = new java.io.FileInputStream(replayPath);
                    java.io.OutputStream os = outputPath != null ? new java.io.FileOutputStream(outputPath)
                            : System.out) {
                new Parse(is, os, true, true);
            }
            return;
        }
