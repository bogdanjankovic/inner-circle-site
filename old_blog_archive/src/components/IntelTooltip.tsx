            ...
            <AnimatePresence>
                {isHovered && (
                    ...
                    >
                        ...
                        <div className="bg-black/90 border border-green-500/30 backdrop-blur-md p-1.5 rounded-sm shadow-[0_0_20px_rgba(34,197,94,0.2)] overflow-hidden relative">
                            {/* Decorative Corners */}
                            ...
                            {/* Header */}
                            <div className="flex justify-between items-center mb-0 border-b border-green-500/20 pb-0">
