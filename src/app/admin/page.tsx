                ...
                <div className="mb-12">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <a
                            ...
                            download
                            className="text-[10px] font-bold uppercase tracking-widest text-purple-500 hover:text-purple-400 border border-purple-500/20 bg-purple-500/10 px-3 py-1.5 rounded hover:bg-purple-500/20 transition-all flex items-center gap-2"
                        >
